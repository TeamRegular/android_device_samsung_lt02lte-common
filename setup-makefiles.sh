...
LINEEND=" \\"
COUNT=`wc -l ../lt02lte-common/proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../lt02lte-common/proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
FIRST=1
...
LINEEND=" \\"
COUNT=`wc -l ../lt02lte-common/common-proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../lt02lte-common/common-proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
